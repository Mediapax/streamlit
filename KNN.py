...
def KNN():
    ...
    with st.expander("Simulations en faisant varier les principaux paramètres (Accuracy=0.86, F1-Score=0.65)"):
        ...
        with tab4:
            ...
            "<p>Metric = Manhattan ou L1 ou Cityblock<p>Weights = Distance</td></tr>"\
            "<tr><td style='width:50%;'><p>F1-Score : 0.650<p>Accuracy : 0.862<p>Recall : 0.586<p>Precision : 0.731<p>Specificity : 0.939</td><td style='width:50%;'><p>k = 4"\
            "<p>Metric = Manhattan ou L1 ou Cityblock<p>Weights = Distance</td></tr>"\
    ...
    with st.expander("Création d'une 'metric' personnalisée : 'distance_mi' (Accuracy=0.85, F1-Score=0.61)"):
        ...
        tab1, tab2, tab3, tab4 = st.tabs(["Définition de notre 'metric' personnalisée.", "Simulation", "Distance perso. et 'Brute Force'", "Résultat obtenu"])
        ...
        with tab4 :
            ...
            "<tr><td style='width:50%;'>accuracy </td><td style='width:50%;'>0.8469965999244428</td></tr>"\
            ...
            "<tr><td style='width:50%;'>f1-score</td><td style='width:50%;'>0.6097848196124611</td></tr>"\
    ...
    with st.expander("Création d'une fonction de pondération personnalisée : 'weights_sqr' (Accuracy=0.87, F1-Score=0.66)"):
        ...
        tab1, tab2 = st.tabs(["Définition de la focntion 'weights_sqr'", "Simulation et résultats"])
        ...
        with tab2 :
            ...
            "<tr><td style='width:50%;'><p>F1-Score : 0.662<p>Accuracy : 0.870<p>Recall : 0.580<p>Precision : 0.770<p>Specificity : 0.951</td><td style='width:50%;'>"\
    ...
    with st.expander("Modification du jeu de données via une pondération : Information Mutuelle (Accuracy=0.86, F1-Score=0.63)"):
        ...
        tab1, tab2 = st.tabs(["Pondération par l'Information Mutuelle", "Résultats"])
        ...
        with tab1 :
            ...
            st.write("")
            st.write("Il pourrait être tentant de tronquer notre jeu de données et de noue limiter à ces 15 vbariables. Cependant, toute l'information Mutuelle disponible ne"\
        ...
        with tab2 :
            ...
            "<tr><td style='width:50%;'><p>F1-Score : 0.627<p>Accuracy : 0.861<p>Recall : 0.532<p>Precision : 0.763<p>Specificity : 0.953</td><td style='width:50%;'>"\
                "<p>k = 11<p>Metric = manhattan<p>Weights = weights_sqr4</td></tr>"\
            "<tr><td style='width:50%;'><p>F1-Score : 0.628<p>Accuracy : 0.860<p>Recall : 0.538<p>Precision : 0.753<p>Specificity : 0.950</td><td style='width:50%;'>"\
    ...
    with st.expander("Utilisation d'une PCA sur KNN (Accuracy=0.86, F1-Score=0.63)"):
        st.write("")

        tab1, tab2, tab3, tab4 = st.tabs(["Principe", "PCA, KNN et Kapy", "Simulations", "Meilleurs Résultats"])
        ...
        with tab3 :
            ...
            st.write("Les résultats sont les suivants :")
            # fichier : KNN Simulations PCA sans reduc de dim.ipynb
        ...
        with tab4 :
            st.write("")
            st.write("Résultats et Conclusion")
            st.write("reporter les meilleurs résultats 'compromis' page +-36 PCA du rapport")
            
            st.write("L’utilisation de la PCA n’apporte pas de plus-value pour KNeighborsClassifier dans le cadre de Kapy. "\
                     "Nous devons donc continuer à utiliser la PCA dans son cadre habituel : une réduction de dimension tout "\
                        "en gardant un maximum de la variance expliquée. Ceci permet de diminuer de manière très notoire la "\
                            "durée des simulations, au prix toutefois d’une performance amoindrie.")
            st.write("je suis à la page37 !!!")
