...
def KNN():
    ...
    with st.expander("Simulations en faisant varier les principaux paramètres (Accuracy=0.86, F1-Score=0.65)"):
        ...
        with tab2: 
            ...
            st.image(loadImage(BokehSimuPrincipauxResultats,800))
    ...
    with st.expander("Création d'une fonction de pondération personnalisée : 'weights_sqr' **(Accuracy=0.87, F1-Score=0.66)**"):
        ...
        with tab2 :
            ...
            st.image(loadImage(BokehSimuFctPondPersonnaliseeWeightsSQR,800))
    ...
    with st.expander("Modification du jeu de données via une pondération : Information Mutuelle (Accuracy=0.86, F1-Score=0.63)"):
        ...
        with tab2 :
            ...
            @st.cache_data
            def bokeh_KNNsimu_pond_var_inf_mut_v1_0():
            ...
            st.image(loadImage(BokehSimuPondViaInformationMutuelle,800))
    ...
    with st.expander("Utilisation d'une PCA sur KNN (Accuracy=0.87, F1-Score=0.65)"):
        ...
        with tab3 :
            ...
            st.image(loadImage(BokehSimuPCA12Composantes,800))
            ...
            st.image(loadImage(BokehSimuPCA28ComposantesSansPondération,800))
            ...
            @st.cache_data
            def bokeh_KNNsimu_pond_PCA_28c_v1_0():
                # fichier : KNN Simulations PCA sans reduc de dim.ipynb
            ...
            st.image(loadImage(BokehSimuPCA28ComposantesAvecPondération,800))
    ...
    with st.expander("Utilisation de KNeighborsClassifier sur un KMeans (Accuracy=0.83, F1-Score=0.66)"):
        ...
        with tab2 :
            ...
            with soustab1:
                ...
                st.image(loadImage(BokehSimuKMeans500s500p,800))
            ...
            with soustab2:
                ...
                @st.cache_data
                def bokeh_KNNsimu_kmeans_400s_600p_v1_0():
                    # fichier : KaPy - Reequilibrage des donnees - ClusterCentroids - KNN local.ipynb
                ...
                st.image(loadImage(BokehSimuKMeans400s600p,800))
            ...
            with soustab3:
                ...
                @st.cache_data
                def bokeh_KNNsimu_kmeans_200s_800p_v1_0():
                    # fichier : KaPy - Reequilibrage des donnees - ClusterCentroids - KNN local.ipynb
                ...
                st.image(loadImage(BokehSimuKMeans200s800p,800))
            ...
            with soustab4:
                ...
                @st.cache_data
                def bokeh_KNNsimu_kmeans_600s_400p_v1_0():
                    # fichier : KaPy - Reequilibrage des donnees - ClusterCentroids - KNN local.ipynb
                ...
                st.image(loadImage(BokehSimuKMeans600s400p,800))
            ...
            with soustab5:
                ...
                @st.cache_data
                def bokeh_KNNsimu_kmeans_50s_50p_v1_0():
                    # fichier : KaPy - Reequilibrage des donnees - ClusterCentroids - KNN local.ipynb
                ...
                st.image(loadImage(BokehSimuKMeans50s50p,800))
            ...
            with soustab6:
                ...
                @st.cache_data
                def bokeh_KNNsimu_kmeans_15s_15p_v1_0():
                    # fichier : KaPy - Reequilibrage des donnees - ClusterCentroids - KNN local.ipynb
                ...
                st.image(loadImage(BokehSimuKMeans15s15p,800))
            ...
            with soustab7:
                ...
                @st.cache_data
                def bokeh_KNNsimu_kmeans_100s_100p_v1_0():
                    # fichier : KaPy - Reequilibrage des donnees - ClusterCentroids - KNN local.ipynb
                ...
                st.image(loadImage(BokehSimuKMeans100s100p,800))
